...
import com.capstone.bgjobs.dto.event.AckTicketCreateJobEvent;
...
@Service
public class AckTicketCreateJobEventProducer {

    private final KafkaTemplate<String, String> kafkaTemplate;
    private final ObjectMapper objectMapper;

    public AckTicketCreateJobEventProducer(KafkaTemplate<String, String> kafkaTemplate,
    ...
    public void produce(Long jobId, JobStatus status) {
        try {
            ...
            AckTicketCreateJobEvent ackEvent = new AckTicketCreateJobEvent(payload);

            String json = objectMapper.writeValueAsString(ackEvent);

            kafkaTemplate.send(KafkaTopic.ACK_JOB.getTopicName(),
                                AckTicketCreateJobEvent.class.getSimpleName(),
                               json);
